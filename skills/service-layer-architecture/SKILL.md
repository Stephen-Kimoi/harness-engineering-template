...
metadata:
  hermes:
    tags: [agentic-engineering, refactor, service-layer, code-quality, architecture]
    related_skills: [code-structure-cleanup, agentic-engineering-workflow]
---
...
For a higher-level cleanup workflow prompt, see [`code-structure-cleanup`](../code-structure-cleanup/SKILL.md).
